...
temp_path = Path('./tempfolder') # tempfiles for parallel
...
def stitch_fromframesunprocessed(pathtoframes='1', how_to_stitch=True, step=1, overlap=5, num_to_stitch=10,
    ...
    if how_to_stitch:
        ...
        stitcher_settings.update({'crop': True,
                                  ...
                                  'final_megapix': 3, })  # панорама ограничена примерно 32000
        # пикселей по ширине/высоте. Последняя склейка делает это число больше,
